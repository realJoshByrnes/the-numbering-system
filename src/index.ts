...
export const incomingOnlyInternational = /^1(?:0(?:(?:3[1-3]|68)|10[034])|2014[1-3])$/;
...
export const operatorService = /^12(?:4(?:5\d|88)|55\d|68[689])$/; // Needs additions from lines 119-150
export const paging = /^0160[1-9]\d$/;
export const virtualPrivateNetwork = /^188\d{2}$/;
export const callingCard = /^189\d{2}$/;
export const testingService = /^127220$/;
